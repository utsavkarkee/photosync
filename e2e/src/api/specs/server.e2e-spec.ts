  ...
  describe('GET /server/about', () => {
    ...
    it('should return about information', async () => {
      ...
      expect(body).toEqual({
        ...
        repositoryUrl: 'https://github.com/wonderkidshihab/photo-backup',
        build: '1234567890',
        buildUrl: 'https://github.com/wonderkidshihab/photo-backup/actions/runs/1234567890',
        buildImage: 'e2e',
        buildImageUrl: 'https://github.com/wonderkidshihab/photo-backup/pkgs/container/immich-server',
        sourceRef: 'e2e',
        sourceCommit: 'e2eeeeeeeeeeeeeeeeee',
        sourceUrl: 'https://github.com/wonderkidshihab/photo-backup/commit/e2eeeeeeeeeeeeeeeeee',
