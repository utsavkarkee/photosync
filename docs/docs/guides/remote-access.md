...
This page gives a few pointers on how to access your  Photosync  instance from outside your LAN.
...
You may use a VPN service to open an encrypted connection to your  Photosync  instance. OpenVPN and Wireguard are two popular VPN solutions. Here is a guide on setting up VPN access to your server - [Pihole documentation](https://docs.pi-hole.net/guides/vpn/wireguard/overview/)
...
:::tip Video tutorial
You can learn how to set up Tailscale together with  Photosync  with the [tutorial video](https://www.youtube.com/watch?v=Vt4PDUXB_fg) they created.
:::
...
A reverse proxy is a service that sits between web servers and clients. A reverse proxy can either be hosted on the server itself or remotely. Clients can connect to the reverse proxy via https, and the proxy relays data to Immich. This setup makes most sense if you have your own domain and want to access your  Photosync  instance just like any other website, from outside your LAN. You can also use a DDNS provider like DuckDNS or no-ip if you don't have a domain. This configuration allows the  Photosync  Android and iphone apps to connect to your server without a VPN or tailscale app on the client side.
...
You'll also need your own certificate to authenticate https connections. If you're making  Photosync  publicly accessible, [Let's Encrypt](https://letsencrypt.org/) can provide a free certificate for your domain and is the recommended option. Alternatively, a [self-signed certificate](https://en.wikipedia.org/wiki/Self-signed_certificate) allows you to encrypt your connection to Immich, but it raises a security warning on the client's browser.
...
- Depending on your configuration, both the  Photosync  web interface and API may be exposed to the internet.  Photosync  is under very active development and the existence of severe security vulnerabilities cannot be ruled out.
