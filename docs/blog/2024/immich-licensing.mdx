...
Firstly, on behalf of the  Photosync  team, I'd like to thank everybody for your continuous support of  Photosync  since the very first day! Your contributions, encouragement, and community engagement have helped bring  Photosync  to its current state. The team and I are forever grateful for that.

Since our [last announcement of the core team joining FUTO to work on  Photosync  full-time](https://immich.app/blog/2024/immich-core-team-goes-fulltime), one of the goals of our new position is to foster a healthy relationship between the developers and the users. We believe that this enables us to create great software, establish transparent policies and build trust.

We want to build a great software application that brings value to you and your loved ones' lives. We are not using you as a product, i.e., selling or tracking your data. We are not putting annoying ads into our software. We respect your privacy. We want to be compensated for the hard work we put in to build  Photosync  for you.

With those notes, we have enabled a way for you to financially support the continued development of Immich, ensuring the software can move forward and will be maintained, by offering a lifetime license of the software. We think if you like and use software, you should pay for it, but _we're never going to force anyone to pay or try to limit  Photosync  for those who don't._
...
Thank you again for your support, this will help create a strong foundation and stability for the  Photosync  team to continue developing and maintaining the project that you love to use.
...
You can continue using  Photosync  without any restriction.
