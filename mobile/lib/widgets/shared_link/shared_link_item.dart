...
import 'package:mediab/widgets/search/thumbnail_with_info.dart';
  ...
  Widget getExpiryDuration(bool isDarkMode) {
    ...
    if (sharedLink.expiresAt != null) {
      ...
      if (difference.inDays > 0) {
        ...
        expiresText = "shared_link_expires_days".tr(args: [dayDifference.toString()]);
      } else if (difference.inHours > 0) {
        expiresText = "shared_link_expires_hours".tr(args: [difference.inHours.toString()]);
      } else if (difference.inMinutes > 0) {
        expiresText = "shared_link_expires_minutes".tr(args: [difference.inMinutes.toString()]);
      } else if (difference.inSeconds > 0) {
        expiresText = "shared_link_expires_seconds".tr(args: [difference.inSeconds.toString()]);
      }
    }
    return Text(
      expiresText,
