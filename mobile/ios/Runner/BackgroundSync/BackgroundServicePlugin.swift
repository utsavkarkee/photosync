...
class BackgroundServicePlugin: NSObject, FlutterPlugin {
    ...
    // e -l objc -- (void)[[BGTaskScheduler sharedScheduler] _simulateLaunchForTaskWithIdentifier:@"com.mediab.app.backgroundFetch"]
    // or
    // e -l objc -- (void)[[BGTaskScheduler sharedScheduler] _simulateLaunchForTaskWithIdentifier:@"com.mediab.app.backgroundProcessing"]
    ...
    // In my tests, I can only get com.mediab.app.backgroundProcessing simulated by running the above command
    
    // This is the task ID in Info.plist to register as our background task ID
    public static let backgroundFetchTaskID = "com.mediab.app.backgroundFetch"
    public static let backgroundProcessingTaskID = "com.mediab.app.backgroundProcessing"
